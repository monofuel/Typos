...
The main branch tests are failing at commit 0f3dbb2. Diagnose the failure from the test output below and fix the root cause. Keep the fix minimal and targeted.
...
Hint: used config file '/mnt/steel-chest/Monolab/Home/racha/src/Typos/tests/config.nims' [Conf]
Hint: mm: orc; threads: on; opt: speed; options: -d:release
51079 lines; 0.016s; 60.246MiB peakmem; proj: /mnt/steel-chest/Monolab/Home/racha/src/Typos/tests/test_mcp_tools.nim; out: /home/scriptorium/.cache/nim/test_mcp_tools_r/test_mcp_tools_216DF98BFBE937B35DF582F9147D799A99A3BC60 [SuccessX]
